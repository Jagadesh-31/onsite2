...
const submitHandler = () => {
  ...
  if (token) {
    ...
    axios
      .get(`http://localhost:5000/user/getInfo`, {
        headers: {
      ...
      .then(res => {
        ...
        console.log(res.data[0]);
              axios
            .get(`http://localhost:5000/user/getCode?userId=${res.data[0]._id}`, {
             })
            .then(r => {
...
const openNewTab = () => {
  ...
  const popup = window.open('http://localhost:5173?redirect=true', '_blank', 'width=500,height=600');
